...
INSERT INTO user (created_date, email, name, password, contacts)
VALUES (
        '2022-04-26',
        'user1@gmail.com',
        'Елена',
...
/*ставки*/
INSERT INTO bid (user_id, lot_id, created_date, price)
VALUES ('1', '2', '2022-04-27', '160499'),
...
UPDATE lot
SET name = 'Жилет для сноуборда DC Mutiny Charocal'
WHERE id = 5;
